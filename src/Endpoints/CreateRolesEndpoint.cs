...
{
    internal class CreateRolesEndpoint : IEndpointHandler
    {
        ...
        public async Task<IEndpointResult> ProcessAsync(HttpContext context)
        {
            ...
            return await ProcessCreateRolesRequestAsync(context);
        }


        private async Task<IEndpointResult> ProcessCreateRolesRequestAsync(HttpContext context)
        {
            ...
            try
            {
                ...
                var response = await _roleService.Insert(roleForm);
