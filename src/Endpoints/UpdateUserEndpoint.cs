...
{
    internal class UpdateUserEndpoint : IEndpointHandler
    {
        ...
        public async Task<IEndpointResult> ProcessAsync(HttpContext context)
        {
            ...
            return await ProcessUpdateUserRequestAsync(context);
        }


        private async Task<IEndpointResult> ProcessUpdateUserRequestAsync(HttpContext context)
        {
            ...
            try
            {
                ...
                var response = await _usersService.Update(userForm, userForm.Id);
